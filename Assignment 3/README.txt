Hi and welcome to Group 8's GUI. Please refer to the following instructions in order to run this APP succesfully. 

1. All required installs for the modules used will be found in requirments.txt
2. Images you can you for image to text have been provided for examples sake 
